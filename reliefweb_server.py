...
def serve_frontend():
    ...
    html_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'demo_standalone.html')
    if os.path.exists(html_path):
        return send_file(html_path)
    return jsonify({'status': 'online', 'message': 'ReliefWeb Fetcher API is running. Frontend not found.'})
